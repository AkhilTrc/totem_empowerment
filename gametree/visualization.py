...
class Visualization():
    ...
    def plot_progress(self, history, metrics):
        ...
        # save plot
        plt.savefig('gametree/data/{}/{}-round{}-trainProgress.png'.format(self.time, self.model_type, self.step))
        plt.savefig('gametree/data/{}/{}-round{}-trainProgress.svg'.format(self.time, self.model_type, self.step))
        plt.close()
    ...
    def plot_confusion_matrix(self, labels, predictions, p=0.5 ):
        ...
        # save plot
        plt.tight_layout()
        plt.savefig('gametree/data/{}/{}-round{}-confusionMatrix.png'.format(self.time, self.model_type, self.step))
        plt.savefig('gametree/data/{}/{}-round{}-confusionMatrix.svg'.format(self.time, self.model_type, self.step))
        plt.close()
    ...
    def plot_roc(self, labels, predictions):
        ...
        # save plot
        plt.tight_layout()
        plt.savefig('gametree/data/{}/{}-round{}-rocCurve.png'.format(self.time, self.model_type, self.step))
        plt.savefig('gametree/data/{}/{}-round{}-rocCurve.svg'.format(self.time, self.model_type, self.step))
        plt.close()
    ...
    def plot_ranks(self, *ranks):
        ...
        # save plot
        plt.tight_layout()
        plt.savefig('gametree/data/{}/{}-round{}-rankDensity.png'.format(self.time, self.model_type, self.step))
        plt.savefig('gametree/data/{}/{}-round{}-rankDensity.svg'.format(self.time, self.model_type, self.step))
        plt.close()
