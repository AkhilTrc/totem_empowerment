...
t = open("totemgame/data/{}Elements.json".format(game_version))
translation = json.load(t)

d = open("customgametree/data/{}ChildrenEmpowermentTable-{}-{}.json".format(game_version, split_version, vector_version))
data = json.load(d)
empvalues = []
index = []
...
p = open("totemgame/data/{}ParentTable.json".format(game_version))
...
empowerment_table.to_csv("gametree/data/element_empowerment/{}_element_empowerment_dataframe.csv".format(game_version), index = False)
