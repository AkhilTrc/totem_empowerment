...
if __name__ == '__main__':
    ...
    # plot info for user
    print('\nRun models. Save logs to directory gametree/data/{}'.format(time))
    ...
    print('\nWrite to HDF5 file.')
    gametree_table.to_hdf('gametree/data/{}/{}GametreeTable-{}-{}{}.h5'.format(time, game_version, split_version, vector_version, dim), key='gametreeTable', mode='w')
