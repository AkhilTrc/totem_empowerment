...
class Empowerment():
    ...
    def plot_empowerment_histogram(self):
        ...
        # save figure
        filename = 'data/figures/{}EmpowermentHistogram-{}-{}'.format(self.game_version, self.split_version, self.vector_version)
    ...
    def plot_empowerment_scatter_plot(self):
        ...
        # save figure
        filename = 'data/figures/{}EmpowermentRegression-{}-{}'.format(self.game_version, self.split_version, self.vector_version)
        plt.savefig('{}.svg'.format(filename))
        plt.savefig('{}.png'.format(filename))
        plt.savefig('{}.pdf'.format(filename))
        plt.close()
